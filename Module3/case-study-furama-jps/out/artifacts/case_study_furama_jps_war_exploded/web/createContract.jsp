...
<div class="container-fluid">
    <div class="row justify-content-center" style="background-image: url('../image/4.jpg'); background-repeat: no-repeat;background-size :100% 900px ">
        <div class="col-5 " style="margin-left: 30px">
            ...
            <form method="post">
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control form-control-sm" id="contractDate">
                    </div>
                </div>
                <div class="input-group row">
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="money">
                    </div>
                </div>
                <div class="input-group row">
                    <label for="totalMoney" class="col-sm-2 col-form-label-sm text-white">Total Money</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="totalMoney">
                    </div>
                </div>
                <div class="col-sm-10">
