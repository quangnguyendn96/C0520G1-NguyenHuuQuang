...
<div class="row">
    <div class="col-3" style="background: #bee5eb">
        <div class="col-12" style="height: 100px">
            <a href="/customer?action=createObj">
                <button type="button" class="btn btn-outline-success" style="height: 50px;width: 200px">Create new customer</button>
            </a>
        </div>
        <div class="col-12" style="height: 100px">
            <a href="/home">
                <button type="button" class="btn btn-outline-success" style="height: 50px;width: 200px">Back to home</button>
            </a>
        </div>
        <div class="col-12">
