<div class="row mt-2" style="position: absolute">
    <div class="col-1"></div>
    <div class="col-2" style="height: 100px">
        <a href="/home">
            <img src="../../image/logo.png" style="height: 100px;width: 80px;font-weight: lighter"></a>
        </a>
    </div>
    <div class="col-3">
        <a href="/home">
            <img src="../../image/8.png" style="height: 90px;width: 240px"></a>
        </a>
    </div>
...
<div class="row">
    <div class="col-12 mt-0">
        <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #046056;position: sticky">
