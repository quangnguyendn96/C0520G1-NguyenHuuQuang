...
<table class="table table-striped table-hover">
    ...
    <c:forEach var="customer" items="${listCus}">
        <tr>
            <th scope="col"><a href="/home?action=viewCustomerById&id=${customer.idCustomer}">
            ...
            <td scope="col"><a href="/home?action=editCustomer&id=${customer.idCustomer}">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="/home?action=deleteCustomer&id=${customer.idCustomer}">
