package session16_textfile.demo.baihoc;
...
public class CharacterFile {
    public static void readFile() {
        File file = new File("D:\\Work\\CodeGym\\C05\\Module2\\sourcedemo\\src\\io_text_file\\demo.txt");
        try {
    ...
    public static void writeFile2(Student student) {
        File file = new File("D:\\Work\\CodeGym\\C05\\Module2\\sourcedemo\\src\\io_text_file\\student2.txt");
        try {
